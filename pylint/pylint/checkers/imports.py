...
MSGS: dict[str, MessageDefinitionTuple] = {
    "E0401": (
        ...
        "W0405": (
            ...
            "optional-import-error",
            "Used when an import fails but the module is configured as optional. "
            "These imports are treated as warnings instead of errors.",
        ),
    "E0402": (
...
class ImportsChecker(DeprecatedMixin, BaseChecker):
    ...
    * uses of modules instead of preferred modules
    ...
    options = (
        ...
        (
            "optional-import-modules",
            {
                ...
                "help": (
                    "Modules that are considered optional dependencies. "
                    "Missing imports will emit 'optional-import-error' instead of 'import-error'."
                ),
            },
        ),
    )
    ...
    def open(self) -> None:
        ...
        self._optional_import_modules = tuple(
            self.linter.config.optional_import_modules or ()
        )
    ...
    def _get_imported_module(
        ...
        try:
            ...
            message_id = "import-error"
            if self._is_optional_import(dotted_modname):
                message_id = "optional-import-error"
            self.add_message(message_id, args=repr(dotted_modname), node=importnode)
        except Exception as e:  # pragma: no cover
            raise astroid.AstroidError from e
        return None

    def _is_optional_import(self, dotted_modname: str) -> bool:
        for module in self._optional_import_modules:
            if dotted_modname == module or dotted_modname.startswith(f"{module}."):
                return True
        return False
