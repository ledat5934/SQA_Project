...
"""""""""""""""""""""""""
*Modules that are treated as optional dependencies. Missing imports emit ``optional-import-error`` instead of ``import-error``.*
...
--high-risk-fixme-rgx
"""""""""""""""""""""
*Regular expression used to flag TODO / FIXME notes as high risk and emit ``high-risk-todo``.*
